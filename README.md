...
```
========================================
  RelayKV Full Command Battery Test
========================================
--- PING ---
PASS: PING
...
--- DEL ---
PASS: DEL existing key
PASS: DEL already deleted
PASS: DEL multiple keys
--- INCR ---
PASS: INCR new key
PASS: INCR existing key
PASS: INCR existing key again
PASS: INCR on non-integer returns error
--- TTL / Expiration ---
PASS: TTL no expiry
PASS: TTL missing key
PASS: TTL after 1s
PASS: GET after expiry
PASS: TTL after expiry
--- List Commands ---
PASS: LPUSH single
PASS: LPUSH multiple
PASS: RPUSH single
PASS: LRANGE full list
--- LPOP / RPOP ---
PASS: LPOP
PASS: RPOP
PASS: LPOP empty key
PASS: RPOP empty key
--- AOF Persistence ---
PASS: AOF write survives
--- PUBLISH ---
PASS: PUBLISH delivers to subscriber
PASS: Subscriber received message
--- Type Safety ---
PASS: LPUSH on string key returns WRONGTYPE
========================================
